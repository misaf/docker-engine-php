...
namespace Misaf\DockerEngine\Api\V1_55\Image;
...
final class ImageApi extends GeneratedImageApi
{
    ...
    public function attestations(Requests\ImageAttestationsRequest|string|\Misaf\DockerEngine\ValueObjects\ImageReference $request): Responses\ImageAttestationsResponse
    {
        $request = $request instanceof Requests\ImageAttestationsRequest
            ? $request
            : new Requests\ImageAttestationsRequest(name: $request);
