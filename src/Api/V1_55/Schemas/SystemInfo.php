...
readonly class SystemInfo
{
     ...
     * @param FirewallInfo|Undefined $firewallBackend
     * @param list<DeviceInfo>|Undefined $discoveredDevices
     * @param NRIInfo|Undefined $nri
     * @param list<string>|Undefined $warnings
     * @param list<string>|Undefined $cdiSpecDirs
     * @param ContainerdInfo|Undefined $containerd
     */
    public function __construct(
        ...
        #[SerializedName('FirewallBackend')]
        public FirewallInfo|Undefined $firewallBackend = Undefined::Value,
        #[SerializedName('DiscoveredDevices')]
        #[ArrayOf(DeviceInfo::class)]
        public array|Undefined $discoveredDevices = Undefined::Value,
        #[SerializedName('NRI')]
        public NRIInfo|Undefined $nri = Undefined::Value,
        ...
        public ContainerdInfo|Undefined $containerd = Undefined::Value,
    ) {}
}
