...
{
    /**
     * @param list<\Misaf\DockerEngine\Api\V1_51\Schemas\ImageDeleteResponseItem>|Undefined $imagesDeleted
     */
    public function __construct(
        #[SerializedName('ImagesDeleted')]
        #[ArrayOf(\Misaf\DockerEngine\Api\V1_51\Schemas\ImageDeleteResponseItem::class)]
