...
{
    /**
     * @param list<\Misaf\DockerEngine\Api\V1_42\Schemas\ImageDeleteResponseItem>|Undefined $imagesDeleted
     */
    public function __construct(
        #[SerializedName('ImagesDeleted')]
        #[ArrayOf(\Misaf\DockerEngine\Api\V1_42\Schemas\ImageDeleteResponseItem::class)]
