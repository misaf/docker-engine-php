...
{
    /**
     * @param \Misaf\DockerEngine\Api\V1_43\Schemas\ContainerConfig|Undefined $containerConfig
     */
    public function __construct(
        #[RequestParameter('containerConfig', 'body', false)]
        public \Misaf\DockerEngine\Api\V1_43\Schemas\ContainerConfig|Undefined $containerConfig = Undefined::Value,
