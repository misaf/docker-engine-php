...
final readonly class ContainerInspectResponse
{
     ...
     * @param \Misaf\DockerEngine\Api\V1_46\Schemas\ContainerState|Undefined $state
     * @param list<string>|Undefined $execIDs
     * @param \Misaf\DockerEngine\Api\V1_46\Schemas\HostConfig|Undefined $hostConfig
     * @param \Misaf\DockerEngine\Api\V1_46\Schemas\GraphDriverData|Undefined $graphDriver
     * @param list<\Misaf\DockerEngine\Api\V1_46\Schemas\MountPoint>|Undefined $mounts
     * @param \Misaf\DockerEngine\Api\V1_46\Schemas\ContainerConfig|Undefined $config
     * @param \Misaf\DockerEngine\Api\V1_46\Schemas\NetworkSettings|Undefined $networkSettings
     */
    public function __construct(
        ...
        public \Misaf\DockerEngine\Api\V1_46\Schemas\ContainerState|Undefined $state = Undefined::Value,
        ...
        public \Misaf\DockerEngine\Api\V1_46\Schemas\HostConfig|Undefined $hostConfig = Undefined::Value,
        #[SerializedName('GraphDriver')]
        public \Misaf\DockerEngine\Api\V1_46\Schemas\GraphDriverData|Undefined $graphDriver = Undefined::Value,
        ...
        #[ArrayOf(\Misaf\DockerEngine\Api\V1_46\Schemas\MountPoint::class)]
        public array|Undefined $mounts = Undefined::Value,
        #[SerializedName('Config')]
        public \Misaf\DockerEngine\Api\V1_46\Schemas\ContainerConfig|Undefined $config = Undefined::Value,
        #[SerializedName('NetworkSettings')]
        public \Misaf\DockerEngine\Api\V1_46\Schemas\NetworkSettings|Undefined $networkSettings = Undefined::Value,
    ) {}
}
