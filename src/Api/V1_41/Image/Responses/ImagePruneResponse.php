...
{
    /**
     * @param list<\Misaf\DockerEngine\Api\V1_41\Schemas\ImageDeleteResponseItem>|Undefined $imagesDeleted
     */
    public function __construct(
        #[SerializedName('ImagesDeleted')]
        #[ArrayOf(\Misaf\DockerEngine\Api\V1_41\Schemas\ImageDeleteResponseItem::class)]
